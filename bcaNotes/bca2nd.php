...
<body>
    ...
    <section>
        <div class="heading">
            <h1>BCA Semester 2nd</h1>
        </div>
        <div class="paragraph">
            <div class="para">In the semester 2nd, there are five subjects: MATH, Adc C, CAAL, POM, FAT and there are two practical (Adc C, FAT).</div>
        </div>
